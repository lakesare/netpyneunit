...
gaba_test_3 = GabaAgonistTest({'value': 0.954}, name='gaba3')
nmda_test   = NmdaAntagonistTest({'value': 0.808}, name='nmda')
nmda_test_2 = NmdaAntagonistTest({'value': 0.808}, name='nmda2')
nmda_test_3 = NmdaAntagonistTest({'value': 0.808}, name='nmda3')

# neuromodulators_suite = sciunit.TestSuite([gaba_test, nmda_test, gaba_test_2, nmda_test_2], name="Neuromodulators test suite")
neuromodulators_suite = sciunit.TestSuite([gaba_test, nmda_test, gaba_test_2, nmda_test_2, gaba_test_3, nmda_test_3], name="Neuromodulators test suite")
